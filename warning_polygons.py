...
#Now for each of the other figures, plot the polygons from the tuple if they are contained within the region
...
for group in df.groupby(df[3]):
    ...
    plt.savefig('testing' + name + '.png', bbox_inches='tight')
    plt.close()
